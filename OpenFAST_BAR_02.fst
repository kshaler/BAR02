...
---------------------- INPUT FILES ---------------------------------------------
"OpenFAST_BAR_02_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
---------------------- VISUALIZATION ------------------------------------------
1                      WrVTK       - VTK visualization data output: (switch) {0=none; 1=initialization data only; 2=animation}
